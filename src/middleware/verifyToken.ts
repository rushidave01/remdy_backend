...
const verifyUserAuthMiddleware: RequestHandler = async (
  req: customRequest,
  res: Response,
  next: NextFunction
) => {
...
const verifyAdminAuthMiddleware: RequestHandler = async (
  req: customRequest,
  res: Response,
  next: NextFunction
) => {
...
const verifyDoctorAuthMiddleware: RequestHandler = async (
  req: customRequest,
  res: Response,
  next: NextFunction
) => {
